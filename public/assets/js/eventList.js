import keyDownEnter from "./helper.js"

$(document).ready(function () {
    let le = new ListEvent('#list-event', '/event/list/', '#search', '#display-search', '#rechercher', '.filtre-input')
    le.getContent();
});
...
class ListEvent {
    ...
    displaySearch() {
        ...
        if (classSearch === 'd-none') {
            ...
            $(list.id_display_search).html('<i class="fa fa-times"></i> Annuler la recherche');
        } else {
